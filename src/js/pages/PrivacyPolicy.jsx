    ...
    <>
      <section id="privacy-policy">
        <div className="container-fluid">
          ...
          <h3>Personal Data</h3>
          <p className="privacy-policy-paragraph">
            Personally identifiable information, such as your name, shipping address, email address, and telephone number, and demographic information, such as your age,
            gender, hometown, and interests, that you voluntarily give to us (when you register with the site (or our mobile application,) or) when you choose to participate
            in various activities related to GENEWS, such as online chat and message boards. You are under no obligation to provide us with personal information of any kind,
            however your refusal to do so may prevent you from using certain features of the Genews.
          </p>

          <h3>Derivative Data</h3>
          <p className="privacy-policy-paragraph">
            Information our servers automatically collect when you access the site, such as your IP address, your browser type, your operating system, your access times, and
            the pages you have viewed directly before and after accessing the site. (If you are using our mobile application, this information may also include your device
            name and type, your operating system, your phone number, your country, your likes and replies to a post, and other interactions with the application and other
            users via server log files, as well as any other information you choose to provide.)
          </p>
          ...
          <p className="privacy-policy-paragraph">
            ...
            basic account information, including your name, email, gender, birthday, current city, and profile picture URL, as well as other information that you choose to
            make public. We may also request access to other permissions related to your account, such as friends, checkins, and likes, and you may choose to grant or deny us
            access to each individual permission. For more information regarding Facebook permissions, refer to the{" "}
          ...
          <p className="privacy-policy-paragraph">
            ...
            (If you are using our mobile application, this information may also include the contact information of anyone you invite to use and/or join our mobile
            application).
          </p>
          ...
          <p className="privacy-policy-paragraph">
            ...
            protect the rights, property, and safety of others, we may share your information as permitted or required by any applicable law, rule, or regulation. This
          ...
          <p className="privacy-policy-paragraph">
            We may use third-party advertising companies to serve ads when you visit the site (or our mobile application). These companies may use information about your
            visits to the site (and our mobile application) and other websites that are contained in web cookies in order to provide advertisements about goods and services of
            interest to you.
          </p>
          ...
          <p className="privacy-policy-paragraph">
            We may use cookies, web beacons, tracking pixels, and other tracking technologies on the site (and our mobile application) to help customize the site (and our
            mobile application) and improve your experience. When you access the site (or our mobile application), your personal information is not collected through the use
            of tracking technology. Most browsers are set to accept cookies by default. You can remove or reject cookies, but be aware that such action could affect the
            ...
            cookies or by modifying your web browser’s settings to notify you each time a cookie is tendered, permitting you to accept or decline cookies on an individual
            basis.
          </p>
