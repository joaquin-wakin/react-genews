  ...
  return (
    <section id="terms-and-conditions">
      <div className="container-fluid">
        <h1 className="page-heading__other">Terms &amp; Conditions</h1>
        <h3 className="section-heading">Agreement to Terms</h3>
        <p className="terms-and-conditions-paragraph">
          These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you") and GENEWS ("we," "us" or
          "our"), concerning your access to and use of our website as well as any other media form, media channel, mobile website or mobile application related, linked, or
          otherwise connected thereto (collectively, the "site").
        </p>

        <p className="terms-and-conditions-paragraph">
          You agree that by accessing the site, you have read, understood, and agree to be bound by all of these Terms and Conditions. If you do not agree with all of these
          Terms and Conditions, then you are expressly prohibited from using our site and you must discontinue use immediately.
        </p>

        <p className="terms-and-conditions-paragraph">
          Supplemental terms and conditions or documents that may be posted on the site from time to time are hereby expressly incorporated herein by reference. We reserve the
          right, in our sole discretion, to make changes or modifications to these Terms and Conditions at any time and for any reason.
        </p>

        <p className="terms-and-conditions-paragraph">
          We will alert you about any changes by updating the "last updated" date of these Terms and Conditions, and you waive any right to receive specific notice of each
          such change.
        </p>

        <p className="terms-and-conditions-paragraph">
          It is your responsibility to periodically review these Terms and Conditions to stay informed of updates. You will be subject to, and will be deemed to have been made
          aware of and to have accepted, the changes in any revised Terms and Conditions by your continued use of the Site after the date such revised Terms and Conditions are
          posted.
        </p>

        <p className="terms-and-conditions-paragraph">
          The information provided on the Site is not intended for distribution to or use by any person or entity in any jurisdiction or country where such distribution or use
        ...
        <p className="terms-and-conditions-paragraph">
          Accordingly, those persons who choose to access the Site from other locations do so on their own initiative and are solely responsible for compliance with local
          laws, if and to the extent local laws are applicable.
        </p>

        <p className="terms-and-conditions-paragraph">
          <b>Option 1:</b> The Site is intended for users who are at least 18 years old. Persons under the age of 18 are not permitted to register for the site.
        </p>

        <p className="terms-and-conditions-paragraph">
          <b>Option 2:</b> The site is intended for users who are at least 13 years of age. All users who are minors in the jurisdiction in which they reside (generally under
          the age of 18) must have the permission of, and be directly supervised by, their parent or guardian to use the site. If you are a minor, you must have your parent or
          guardian read and agree to these Terms and Conditions prior to you using the site.
        </p>

        <h3 className="section-heading">Intellectual Propoerty Rights</h3>
        <p className="terms-and-conditions-paragraph">
          ...
          controlled by us or licensed to us, and are protected by copyright and trademark laws and various other intellectual property rights and unfair competition laws of
          the United States, foreign jurisdictions, and international conventions.
        </p>

        <p className="terms-and-conditions-paragraph">
          The Content and the Marks are provided on the site “AS IS” for your information and personal use only. Except as expressly provided in these Terms and Conditions, no
          part of the Site and no Content or Marks may be copied, reproduced, aggregated, republished, uploaded, posted, publicly displayed, encoded, translated, transmitted,
        ...
        <p className="terms-and-conditions-paragraph">
          ...
          Content to which you have properly gained access solely for your personal, non-commercial use. We reserve all rights not expressly granted to you in and to the Site,
        ...
        <h3 className="section-heading">Prohibited Activities</h3>
        <p className="terms-and-conditions-paragraph">
          You may not access or use the site for any purpose other than that for which we make the site available. Our site may not be used in connection with any commercial
          endeavors except those that are specifically endorsed or approved by us.
        </p>

        <p className="terms-and-conditions-paragraph">As a user of the site, you agree not to:</p>
        <ol className="terms-and-conditions-list">
          <li>
          ...
          <li>
            Make any unauthorized use of the site, including collecting usernames and/or email addresses of users by electronic or other means for the purpose of sending
